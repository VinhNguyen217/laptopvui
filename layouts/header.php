...
?>
<?php
$url = $fm->getCurrentPageURL();
?>
<!DOCTYPE HTML>

<head>
	<title>Laptopvui.vn - Hệ thống bán lẻ laptop </title>
	...
	<div class="wrap">
		<div class="header">
			<div class="headertop_desc">
				...
				<div class="account_desc">
					<ul>
						...
						if ($check_login == true) {
						?>
							<li><a href="info.php" class="Info-click"><?= $user ?> </a></li>
						<?php
						}
						?>
						<li>
			...
			<div class="header_top">
				<div class="logo">
					<a href="index.php"><img src="public/frontend/images/logo-laptop-vui.png" alt="" /></a>
				</div>
				<div class="cart">
					<?php
					if ($check_login == false) {
			...
			<div class="header_bottom">
				<div class="menu">
					<ul>
						<li <?php if ($url == "http://localhost:8080/laptopvui/index.php") echo 'class="active"' ?>><a href="index.php">Trang chủ</a></li>
						<li <?php if ($url == "http://localhost:8080/laptopvui/about.php") echo 'class="active"' ?>><a href="about.php">Thông tin</a></li>
						<li <?php if ($url == "http://localhost:8080/laptopvui/delivery.php") echo 'class="active"' ?>><a href="delivery.php">Giao hàng</a></li>
						<li <?php if ($url == "http://localhost:8080/laptopvui/news.php") echo 'class="active"' ?>><a href="news.php">Tin tức</a></li>
						<li <?php if ($url == "http://localhost:8080/laptopvui/contact.php") echo 'class="active"' ?>><a href="contact.php">Liên lạc</a></li>
						<div class="clear"></div>
					</ul>
				</div>
