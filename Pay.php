    ...
    <div class="products-pay">
        <div class="modal-body">
            <div class="cart-row">
                ...
                <span class="cart-quantity cart-header cart-column">Giá</span>
            ...
            ?>
                <div class="cart-row">
                    ...
                    <div class="cart-quantity cart-column">
                        <input class="cart-quantity-input" type="number" value="<?=$result['price']?>"readonly>
                    </div>
                    <div class="cart-quantity cart-column">
                        <?php
    ...
    <div class="order-pay">  
        <?php
            if($_SESSION['check']== true){
                ...
                ?>
                 <form action="" method = "post">
                    <input type="submit" name="info" value="Thanh toán hoá đơn" class="pay-pay">   
                </form>
                <?php
            }
        ?>
