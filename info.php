...
?>
<div class="main_title" style="margin-bottom: 50px;">
    <ul>

        <li><a href="./index.php" style="background: none;padding-left: 10px;">Trang chủ</a></li>
        <li><a>\</a></li>
        <li><a href="info.php" style="background: none;padding-left: 10px;">Thông tin cá nhân </a></li>
    </ul>
</div>
<div class="content-info">
    <div class="form-info">
        ...
        <div class="infor-right"><img src="https://st.quantrimang.com/photos/image/2017/04/08/anh-dai-dien-FB-200.jpg" alt=""></div>
    </div>
